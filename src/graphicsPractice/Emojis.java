...
public class Emojis {
    ...
    public static GraphicsGroup createSmileyFace(double size) {
        ...
        group.add(createEye(size * 0.2, size * 0.3));
        group.add(createEye(size * 0.4, size * 0.06));
    ...
    private static Ellipse createEye(double eyeWidth, double eyeHeight) {
        Ellipse eye = new Ellipse(0,0, eyeWidth, eyeHeight);
